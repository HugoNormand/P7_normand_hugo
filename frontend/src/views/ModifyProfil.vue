...
.img_profilPic {
    ...
    height: 100px;
    object-fit: fill;
    border: solid 3px #4E5166;
    border-radius: 50%
}

.username_modifyProfil {
    color: #4E5166;
    font-size: 20px
}

.block_choose_file_modifyProfil {
    display: flex;
    flex-direction: column;
    align-items: center;
    height: 80px;
...
.block_button_modifyProfil {
    width: 100%
}

.icon_file_modifyProfil {
    display: flex;
    justify-content: center;
    align-items: center;
    font-size: 35px;
