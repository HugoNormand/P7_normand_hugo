<template>
    <div class="block_ModifyPost">
        ...
        <div class="submit_photo" id="remove">
            ...
            <div v-if="ModifyPost.imageUrl" class="modify_image" id="child-remove"><img :src="ModifyPost.imageUrl" alt="image du post"></div>
            <div v-if="data.file"><img :src="data.newImg.src" alt="image du post"></div>
        </div>
