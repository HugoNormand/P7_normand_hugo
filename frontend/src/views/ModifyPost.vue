...
export default {
    ...
    /* fonction created pour récuperer l'id dans le lien */
    created() {
    ...
    methods: {
        ...
        GetOnePost(id){
            ...
            .then((res) => {this.ModifyPost = res.data})
