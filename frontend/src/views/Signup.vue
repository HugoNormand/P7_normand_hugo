  ...
  <form @submit="createAccount" class="form_signup">
      ...
      <!-- formulaire pour l'email -->
        <div class="form-group">
          <label class="label_text_signup" for="email_signup">E-mail : 
          <input class="input_signup_text" id="email_signup" type="email" v-model= "dataForm.email" v-on:change="emailRegExp(dataForm.email)"  placeholder="Entrer son e-mail"></label>
          <p class="msgError_signup">{{ this.msgErrorMail }}</p>
        </div>
      ...
      <!-- formulaire pour le mot de passe -->
       <div class="form-group">
          <label class="label_text_signup" for="password_signup">Mot de passe : 
          <input class="input_signup_text" id="password_signup" type="password" v-model= "dataForm.password" v-on:change="passwordRegExp(dataForm.password)" placeholder="Entrer son mot de passe"></label>
