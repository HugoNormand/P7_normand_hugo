  ...
  <form @submit="createAccount" class="form_signup">
      ...
      <p>Vous avez déjà un compte ? <router-link to="login">Connexion</router-link></p>
        <div class="form-group">
          <label class="label_text_signup" for="exampleInputEmail1">E-mail : </label>
          <input class="input_signup_text" type="email" v-model= "dataForm.email" v-on:change="emailRegExp(dataForm.email)" aria-describedby="emailHelp" placeholder="Entrer son e-mail">
          <p>{{ this.msgErrorMail }}</p>
        </div>

        <div class="form-group">
          <label class="label_text_signup" for="exampleInputEmail1">Pseudo : </label>
          <input class="input_signup_text" type="text" v-model= "dataForm.username" v-on:change="usernameCheck()" aria-describedby="emailHelp" placeholder="Entrer son pseudo">
          <p>{{ this.msgErrorUsername }}</p>
        </div>

       <div class="form-group">
          <label class="label_text_signup" for="exampleInputPassword1">Mot de passe : </label>
          <input class="input_signup_text" type="password" v-model= "dataForm.password" v-on:change="passwordRegExp(dataForm.password)" placeholder="Entrer son mot de passe">
...
.form_signup {
  ...
  border: solid 2px #4E5166;
  padding: 20px;
  width: 60%;
  color: #4E5166;
  background-color: white;
  box-shadow: 2px 2px 2px 2px #4E5166;
  position: absolute;
  top: 50%;
  left: 50%;
