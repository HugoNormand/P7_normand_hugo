...
<main id="login_div">
  <form @submit="accountConnexion" class="block_login">
    ...
    <!-- adresse mail pour se login -->
      <div class="form_group">
        <label class="label_text" for="login_email">E-mail : 
        <input class="input_login_text" type="email" id="login_email" v-model= "dataForm.email" placeholder="Entrer son e-mail">
        </label>
      </div>
    <!-- mot de passe du compte -->
     <div class="form_group">
       <label class="label_text" for="login_password">Mot de passe : 
       <input class="input_login_text" id="login_password" type="password" v-model= "dataForm.password" placeholder="Entrer son mot de passe"></label>
     </div>
    <!-- boutton connexion --> 
